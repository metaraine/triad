...
(function() {
  angular.module('triad').controller('TriadAppCtrl', [
    '$scope', 'PIXI', 'TrianglePerson', '$timeout', function($scope, PIXI, TrianglePerson, $timeout) {
      var people;
...
(function() {
  angular.module("triad").directive("pixi", [
    '$parse', function($parse) {
      ...
      return {
        ...
        scope: false,
        controller: postLink = [
          '$scope', '$element', '$attrs', '$window', '$timeout', 'PIXI', function($scope, $element, $attrs, $window, $timeout, PIXI) {
...
(function() {
  angular.module("triad").directive("resize", [
